"""Framework-layer models for the experiment-engine pipeline.

These models are pipeline-generic: they know about stages, pipelines, configs,
and I/O, but not about QCA domain specifics.
"""
