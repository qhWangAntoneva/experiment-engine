...
| **P1-32** | BERT CLI 命令设计 — bert_engine.py + qca bert-* 子命令 | M | 客户代表 |
| **P1-33** | BERT CLI 可行性 PoC — MiniLM-L6 验证 | M | 客户代表 |
